...
<div class="row">
    <div class="col-md-12">
        <h2>{{ trans('common.create_issue') }}</h2>
    </div>
</div>
...
<form method="post" action="">
            ...
            <div class="form-group">
                ...
                <option></option>
                    @foreach ($priorities as $priority)
                        <option value="{{ $priority->id }}" {{ (old('priority_id') == $priority->id) ? 'selected="selected"' : ''  }}>{{ $priority->name }}</option>
                    @endforeach
                </select>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                @foreach ($projects as $project)
                    <option value="{{ $project->id }}" {{ (old('project_id') == $project->id) ? 'selected="selected"' : ''  }}>{{ $project->name }}</option>
                @endforeach
                </select>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                @foreach ($milestones as $milestone)
                    <option value="{{ $milestone->id }}" {{ (old('milestone_id') == $milestone->id) ? 'selected="selected"' : ''  }}>{{ $milestone->name }}</option>
                    @endforeach
                    </select>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" name="estimate" value="{{ old('estimate') }}" class="form-control" placeholder="{{ trans('common.estimate_placeholder') }}">
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <input type="text" class="form-control" required="required" id="title" name="title" placeholder="{{ trans('common.issue_title_help') }}" value="{{ old('title') }}">
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <textarea required="required" class="form-control" rows="5" placeholder="" id="description" name="description">{{ old('description') }}</textarea>
    ...
    <div class="row">
        <div class="col-md-12">
            <input class="btn btn-primary btn-lg btn-block" type="submit" value="{{ trans('common.create_issue') }}">
        </div>
    </div>
</form>
@endsection